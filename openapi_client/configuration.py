...
class Configuration:
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://localhost:3000/v2.5.6" if host is None else host
        """Default Base url
        """
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "http://localhost:3000/v2.5.6",
                'description': "Dev server",
            },
            {
                'url': "https://bcs-api.wavenetuk.com/v2.5.6",
