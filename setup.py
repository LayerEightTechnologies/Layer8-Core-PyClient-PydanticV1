...
setup(
    name=NAME,
    version=VERSION,
    description="Wavenet Connected API",
    author="Wavenet Development Team",
    author_email="development@wavenetuk.com",
    url="",
    keywords=["OpenAPI", "OpenAPI-Generator", "Wavenet Connected API"],
